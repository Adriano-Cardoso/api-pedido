...
public enum Message {
	...
	STATUS_CANCELADO("O status ja consta como cancelado", HttpStatus.BAD_REQUEST), 
	NOT_FOUND_CLIENTE_ID("O Id do cliente n„o existe ", HttpStatus.NOT_FOUND),
	NOT_FOUND_ITEM_ID("O Id do item n„o existe ", HttpStatus.NOT_FOUND),
	NOT_FOUND_PRODUCT_ID("O Id do produto n„o existe ", HttpStatus.NOT_FOUND),
	NOT_FOUND_PEDIDO_ID("O Id do pedido n„o existe ", HttpStatus.NOT_FOUND);
